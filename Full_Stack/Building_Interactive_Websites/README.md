...
:green_square: **Portfolio Project -** A portfolio project to mark the completion of the Building Interactive Websites and Web Development Foundations module. It is a simple, static personal portfolio website using ``HTML``, ``CSS``, and JavaScript for some interactivity.